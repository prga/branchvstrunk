...
dados_branch = dados[dados['branchORtrunk'] == 'branch']['howManyDevs']
dados_trunk = dados[dados['branchORtrunk'] == 'trunk']['howManyDevs']
...
fig, ax = plt.subplots()
bp = ax.boxplot([dados_branch, dados_trunk], labels=['Branch-based', 'Trunk-based'], showfliers=False)
#plt.title('Team Size by Workflow')
plt.xlabel('Workflow')
...
plt.savefig('boxplot_team_size_vs_workflow.png')
